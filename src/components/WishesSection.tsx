...
export const WishesSection = () => {
  ...
  const [wishForm, setWishForm] = useState<WeddingWishType>({
    name: "",
    message: ""
  });
  ...
  return (
    <WeddingSection id="wishes" className="bg-gradient-to-br from-rose-100 to-pink-200">
      <div className="space-y-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <Button asChild variant="outline" className="border-pink-300 text-pink-600 hover:bg-pink-50 px-8 py-3">
            <Link to="/wishes">
        ...
        <Dialog open={isAddingWish} onOpenChange={setIsAddingWish}>
          <DialogContent className="max-w-md">
            <DialogHeader>
              <DialogTitle className="text-center text-pink-600">Send Your Wedding Wishes</DialogTitle>
            </DialogHeader>
